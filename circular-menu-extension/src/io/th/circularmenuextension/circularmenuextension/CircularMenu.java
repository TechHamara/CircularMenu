...
public class CircularMenu extends ViewGroup {
    ...
    // Optionally set the center view if a layout ID is provided
    int centerViewLayoutId = 0; // Replace with your default or dynamic value if needed
...
protected void onLayout(boolean changed, int l, int t, int r, int b) {
    ...
    if (width == 0 || height == 0) {
        return; // Avoid layout if dimensions are not ready
    }

    // Safe layout logic here
    for (int i = 0; i < getChildCount(); i++) {
        ...
        if (child.getVisibility() != GONE) {
            ...
            // Example layout logic (adjust as needed for CircularMenu)
